...
extern FILE* yyin;
extern uwuscript::Block* programBlock;
...
int main(int argc, char** argv)
{
   ...
   if( !quiet ) {
      std::cout << "uwuscript version " << MAJOR_VER << "." << MINOR_VER << "." << REVISION_VER << "\n";
   }
   ...
   if( programBlock == nullptr ) {
      ...
      uwuscript::CodeGenContext context(quiet ? devNull : std::cout);
...
void usage()
{
   ...
   std::cout << "\t-q be quiet.\n";
   std::cout << "\t-i semicolon separated list of import paths where additional uwuscript files are located.\n";
}
